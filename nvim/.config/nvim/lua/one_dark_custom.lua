...
Group.new("htmlTsTag", c.cPurple, c.none, no)
Group.new("htmlTsText", c.cRedBright, c.none, no)
...
Group.new("TSEmphasis", c.cRedBright, c.none, no)
...
Group.new("TSStrong", c.cRedBright, c.none, no)
