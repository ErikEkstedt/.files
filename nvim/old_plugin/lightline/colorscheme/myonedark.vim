...
" License: MIT License
" =============================================================================
let s:black   = [ '#000001', 233 ]
let s:black2  = [ '#131516', 233 ]
...
let s:tabBG = ['#1B3732', 233 ]
let s:bright_pink = [ '#FF00CA', 161 ]

let s:p.tabline.tabsel  = [ [ s:black, s:bright_pink ] ]
let s:p.tabline.left    = [ [ s:bright_pink, s:black2 ] ]
let s:p.tabline.middle  = [ [ s:green, s:black2] ]
let s:p.tabline.right   = [ [ s:black2, s:pink ] ]

" let s:p.tabline.tabsel  = [ [ s:black, s:pink ] ]
" let s:p.tabline.left    = [ [ s:pink, s:black2 ] ]
" let s:p.tabline.middle  = [ [ s:green, s:black2] ]
" let s:p.tabline.right   = [ [ s:black2, s:pink ] ]
