" =============================================================================
" Filename: autoload/lightline/colorscheme/myseoul256.vim
" Author: atweiden + erik
" License: MIT License
...
let s:p.inactive.left   = [ [ s:base0,  s:black ],  [ s:base00, s:black ] ]
let s:p.inactive.middle = [ [ s:base00, s:black ] ]
let s:p.inactive.right  = [ [ s:base02, s:black ],  [ s:base0,  s:black ] ]

let s:p.insert.left     = [ [ s:base02, s:green ],   [ s:green,  s:base01 ] ]
let s:p.insert.right     = [ [ s:base02, s:green ],   [ s:green,  s:base01 ] ]
let s:p.visual.left     = [ [ s:base02, s:orange ],   [ s:orange,  s:base01 ] ]
let s:p.visual.right     = [ [ s:base02, s:orange ],   [ s:orange,  s:base01 ] ]

let s:p.replace.left    = [ [ s:base02, s:beige ], [ s:beige,  s:base01 ] ]
let s:p.replace.right    = [ [ s:base02, s:beige ], [ s:beige,  s:base01 ] ]
