...
# manni, igor, xcode, vim, autumn
# vs, rrt, native, perldoc, borland
# tango, emacs, friendly, monokai
# paraiso-dark, colorful, murphy
# bw, pastie, paraiso-light, trac
# default, fruity
